...
const JadwalRabuPage = () => {
  ...
  useEffect(() => {
    if (location.pathname === "/jadwal/rabu1") {
      setActiveCard("rabu1");
    } else if (location.pathname === "/jadwal/rabu2") {
      setActiveCard("rabu2");
    } else if (location.pathname === "/jadwal/rabu3") {
      setActiveCard("rabu3");
    } else if (location.pathname === "/jadwal/rabu4") {
      setActiveCard("rabu4");
    }
  }, [location.pathname]);
  ...
  const dayCards = [
    ...
    },
    {
      id: 'rabu2',
      title: 'Rabu 2',
      route: '/jadwal/rabu2', // Ubah ke '#' jika belum ready
      bgColor: 'bg-green-50',
    ...
    },
    {
      id: 'rabu3',
      title: 'Rabu 3',
      route: '/jadwal/rabu3', // Ubah ke '#' jika belum ready
    ...
    },
    {
      id: 'rabu4',
      title: 'Rabu 4',
      route: '/jadwal/rabu4', // Ubah ke '#' jika belum ready
      bgColor: 'bg-yellow-50',
      hoverBgColor: 'group-hover:bg-yellow-100',
      textColor: 'group-hover:text-yellow-600'
    }
