...
const JadwalSelasaPage = () => {
  ...
  useEffect(() => {
    if (location.pathname === "/jadwal/selasa1") {
      setActiveCard("selasa1");
    } else if (location.pathname === "/jadwal/selasa2") {
      setActiveCard("selasa2");
    } else if (location.pathname === "/jadwal/selasa3") {
      setActiveCard("selasa3");
    } else if (location.pathname === "/jadwal/selasa4") {
      setActiveCard("selasa4");
    }
  }, [location.pathname]);
  ...
  const dayCards = [
    ...
    },
    {
      id: 'selasa2',
      title: 'Selasa 2',
      route: '/jadwal/selasa2', // Ubah ke '#' jika belum ready
      bgColor: 'bg-green-50',
    ...
    },
    {
      id: 'selasa3',
      title: 'Selasa 3',
      route: '/jadwal/selasa3', // Ubah ke '#' jika belum ready
    ...
    },
    {
      id: 'selasa4',
      title: 'Selasa 4',
      route: '/jadwal/selasa4', // Ubah ke '#' jika belum ready
      bgColor: 'bg-yellow-50',
      hoverBgColor: 'group-hover:bg-yellow-100',
      textColor: 'group-hover:text-yellow-600'
    }
...
export default JadwalSelasaPage;