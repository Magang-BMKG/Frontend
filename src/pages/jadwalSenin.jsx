...
const JadwalSeninPage = () => {
  ...
  // Checklist functions - Local state management
  ...
  // Fungsi untuk simpan semua perubahan checklist ke server
  ...
  // Fungsi untuk reset checklist manual
  const handleManualReset = async () => {
    const result = await Swal.fire({
      title: 'Reset Checklist',
      text: 'Apakah Anda yakin ingin mereset semua checklist? Semua tugas akan kembali menjadi belum selesai.',
      icon: 'warning',
      showCancelButton: true,
                            ...
                            <td className="px-4 py-4 text-center">
                              {isEditing ? (
                                ...
                                <button
                                  ...
                                  disabled={isDeleteMode || isCompleted}
